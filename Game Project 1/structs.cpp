...
Rectf operator/(Rectf lhs, float rhs)
{
	return Rectf(lhs.left / rhs, lhs.bottom / rhs, lhs.width / rhs, lhs.height / rhs);
}

Rectf operator+(Rectf lhs, Rectf rhs)
{
	return Rectf(lhs.left + rhs.left, lhs.bottom + rhs.bottom, lhs.width + rhs.width, lhs.height + rhs.height);
}
